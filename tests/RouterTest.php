...
use Webshr\Router\Exceptions\NamedRouteNotFoundException;
use Webshr\Router\Exceptions\RouteClassStringControllerNotFoundException;
use Webshr\Router\Exceptions\RouteClassStringMethodNotFoundException;
use Webshr\Router\Exceptions\RouteClassStringParseException;
use Webshr\Router\Exceptions\RouteParamFailedConstraintException;
use Webshr\Router\Exceptions\TooLateToAddNewRouteException;
use Webshr\Router\Route;
use Webshr\Router\RouteGroup;
use Webshr\Router\RouteParams;
...
class RouterTest extends TestCase
{
    ...
    public function match_works_with_a_class_and_method_string()
    {
        ...
        $route = $router->get('/test/123', 'Webshr\Router\Test\Controllers\TestController@returnHelloWorld');
        $response = $router->match($request);
    ...
    public function match_throws_exception_when_class_and_string_method_contains_an_unfound_class()
    {
        ...
        $route = $router->get('/test/123', 'Webshr\Router\Test\Controllers\UndefinedController@returnHelloWorld');
    }
    ...
    public function match_throws_exception_when_class_and_string_method_contains_an_unfound_method()
    {
        ...
        $route = $router->get('/test/123', 'Webshr\Router\Test\Controllers\TestController@undefinedMethod');
    }
